...
public final class Evidence {
    ...
    public static Evidence of(String sourceAdapter, String description, String location, ExtractionFidelity fidelity) {
        return new Evidence(sourceAdapter, description, location, fidelity);
    }

    public static Evidence of(String sourceAdapter, String description, ExtractionFidelity fidelity) {
        return new Evidence(sourceAdapter, description, null, fidelity);
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(sourceAdapter, description, location, fidelity);
    }
